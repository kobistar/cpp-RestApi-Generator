...
public class CppPocoClientCodegen extends CppPocoAbstractCodegen implements CodegenConfig {
    public static final String OPTIONAL_PROJECT_FILE_DESC = "Generate client.pri.";
    // source folder where to write the files
    protected String sourceFolder = "client";
    protected boolean optionalProjectFileFlag = true;

    public CppPocoClientCodegen() {
        super();
        ...
        outputFolder = "generated-code/cpp-poco-client";
         ...
         */
        embeddedTemplateDir = templateDir = "cpp-poco-client";
    ...
    public String getHelp() {
        return "Generates a Poco C++ client library.";
    }
